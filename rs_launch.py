...
configurable_parameters = [{'name': 'camera_name',                  'default': 'camera', 'description': 'camera unique name'},
                           ...
                           {'name': 'pose_fps',                     'default': '0', 'description': "''"},                          
                           ...
                           {'name': 'linear_accel_cov',             'default': '0.0', 'description': "''"},                          
                           ...
                           {'name': 'rgb_camera.power_line_frequency',            'default': '2', 'description': 'rgb_camera.power_line_frequency'},
                          ]
